...
const CoachForm = React.memo(({ state, handleClose }) => {
    ...
    useEffect(() => {
        if (state.open) {
            setForm({
                ...state.coach,
                ci: !!state.coach.ci ? state.coach.ci : "",
                name: !!state.coach.name ? state.coach.name : "",
                first_last_name: !!state.coach.first_last_name
                    ? state.coach.first_last_name
                    : "",
                second_last_name: !!state.coach.second_last_name
                    ? state.coach.second_last_name
                    : "",
        ...
        <Fragment>
            ...
            >
                <DialogTitle style={{ textAlign: "center" }}>
                    {!!state.coach.id ? "Editar" : "Inscribir"}
                </DialogTitle>
                <DialogContent>
                    <form
                        id="form-coach"
            ...
            >
                ...
                <MapContainer
                    center={
                        !!state.coach.address ? state.coach.address : center
                    }
                    zoom={16}
